...
public sealed class PostRenderer : IPostRenderer, IRenderQueue<IRenderEffect>, IDisposable
{
    ...
    public PostRenderer(IRenderDevice renderDevice, int resolutionWidth, int resolutionHeight)
    {
    ...
    private IFrameBuffer FrameBuffer
    {
        get { return this.frameBuffer ??= this.renderDevice.Factory.CreateFrameBuffer(new[] { this.ColorTexture }, this.DepthTexture); }
    }
