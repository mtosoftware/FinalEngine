...
public sealed class ModelResourceLoader : ResourceLoaderBase<Model>
{
    ...
    private static Material LoadMaterial(AssimpMesh mesh, IList<AssimpMaterial> materials, string? directory)
    {
        ...
        if (mesh.MaterialIndex >= 0)
        {
            ...
            {
                result.EmissionTexture = ResourceManager.Instance.LoadResource<ITexture2D>($"{directory}\\{assimpMaterial.TextureEmissive.FilePath}");
            }
        }
