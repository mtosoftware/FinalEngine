namespace FinalEngine.TestGame
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        public void CreateDeviceResources()
        {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, this._vertexBufferSize, IntPtr.Zero, BufferUsageHint.DynamicDraw);
            ...
            GL.BufferData(BufferTarget.ElementArrayBuffer, this._indexBufferSize, IntPtr.Zero, BufferUsageHint.DynamicDraw);
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        private void UpdateImGuiInput(IKeyboard keyboard, IMouse mouse)
        {
            ...
            io.MouseDown[0] = mouse.IsButtonDown(Input.Mouses.MouseButton.Left);
            io.MouseDown[1] = mouse.IsButtonDown(Input.Mouses.MouseButton.Right);
            io.MouseDown[2] = mouse.IsButtonDown(Input.Mouses.MouseButton.Middle);
